...
....
#> ✔ Creating '/tmp/Rtmp4WapQT/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp4WapQT/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|d29b587431… |d-morrison d-morrison@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp4WapQT/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp4WapQT/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp4WapQT/regexcite/README.Rmd'
----
