...
....
#> ✔ Creating '/tmp/Rtmp1eIS7E/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp1eIS7E/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|24ecf53982… |d-morrison d-morrison@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp1eIS7E/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp1eIS7E/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp1eIS7E/regexcite/README.Rmd'
----
