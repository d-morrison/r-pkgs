...
....
#> ✔ Creating '/tmp/Rtmp57zbGp/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp57zbGp/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|2bf45c5b9c… |d-morrison d-morrison@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp57zbGp/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp57zbGp/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp57zbGp/regexcite/README.Rmd'
----
