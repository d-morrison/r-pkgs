...
....
#> ✔ Creating '/tmp/RtmpADpk5c/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpADpk5c/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|0e481a43c8… |d-morrison d-morrison@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpADpk5c/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpADpk5c/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpADpk5c/regexcite/README.Rmd'
----
