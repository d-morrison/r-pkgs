...
....
#> ✔ Creating '/tmp/RtmppjiEJq/regexcite/'
#> ✔ Setting active project to '/tmp/RtmppjiEJq/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|5f2eeb2296… |d-morrison d-morrison@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmppjiEJq/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmppjiEJq/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmppjiEJq/regexcite/README.Rmd'
----
