...
....
#> ✔ Creating '/tmp/RtmpdzO4Xv/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpdzO4Xv/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|cbe8315e28… |d-morrison d-morrison@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpdzO4Xv/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpdzO4Xv/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpdzO4Xv/regexcite/README.Rmd'
----
