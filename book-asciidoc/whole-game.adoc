...
....
#> ✔ Creating '/tmp/RtmpLUwZOL/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpLUwZOL/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|bb98b7c3f8… |d-morrison d-morrison@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpLUwZOL/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpLUwZOL/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpLUwZOL/regexcite/README.Rmd'
----
