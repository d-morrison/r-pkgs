...
....
#> ✔ Creating '/tmp/Rtmp5O0jCn/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp5O0jCn/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|eb1859bc83… |d-morrison d-morrison@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp5O0jCn/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp5O0jCn/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp5O0jCn/regexcite/README.Rmd'
----
