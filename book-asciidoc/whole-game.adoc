...
....
#> ✔ Creating '/tmp/RtmphZ9LJ0/regexcite/'
#> ✔ Setting active project to '/tmp/RtmphZ9LJ0/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|15e0f9dae3… |d-morrison d-morrison@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmphZ9LJ0/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmphZ9LJ0/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmphZ9LJ0/regexcite/README.Rmd'
----
