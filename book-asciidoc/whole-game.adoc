...
....
#> ✔ Creating '/tmp/RtmpEGdTOM/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpEGdTOM/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|82120ddf92… |d-morrison d-morrison@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpEGdTOM/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpEGdTOM/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpEGdTOM/regexcite/README.Rmd'
----
