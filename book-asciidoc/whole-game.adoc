...
....
#> ✔ Creating '/tmp/RtmpYSSH31/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpYSSH31/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|8330b64fa1… |d-morrison d-morrison@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpYSSH31/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpYSSH31/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpYSSH31/regexcite/README.Rmd'
----
